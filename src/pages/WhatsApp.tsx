...
const WhatsApp: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'onboarding' | 'messaging' | 'templates' | 'campaigns' | 'automation'>('onboarding');
    ...
    <div className="max-w-7xl mx-auto p-6 bg-[#f5f5f5] min-h-screen font-inter">
      ...
      >
        {activeTab === 'onboarding' && (
          <OnboardingTab wabaStatus={wabaStatus} setWabaStatus={setWabaStatus} />
        )}
        {activeTab === 'messaging' && (
