...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    setLocalError(null);
    dispatch(setError(null)); // Clear error before new attempt
    ...
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="w-full max-w-2xl bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          {/* Right Segment - Login Form (first on mobile) */}
          <div className="w-full md:w-1/2 p-6 flex flex-col items-center order-1 md:order-2">
            <div className="mb-4">
              <img src={Logo} alt="Logo" className="h-16 w-auto" />
            </div>
            <h2 className="text-lg font-semibold text-[#00333e] mb-2">Log in to your account</h2>
